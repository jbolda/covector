...
describe("fetchCommand", () => {
  ...
  describe("fetch npm registry", () => {
    ...
    it("failure throws", function* () {
      ...
      expect(errored.message).toEqual(
        "effection request to https://registry.npmjs.com/effection/0.5.32 returned code 403: Forbidden"
      );
    });
  ...
  describe("fetch cargo registry", () => {
    ...
    it("failure throws", function* () {
      ...
      expect(errored.message).toEqual(
        "tauri request to https://crates.io/api/v1/crates/tauri/0.12.0 returned code 403: Forbidden"
      );
    });
