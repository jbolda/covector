...
class TomlDocument {
    ...
    static __wrap(ptr) {
        ptr = ptr >>> 0;
        const obj = Object.create(TomlDocument.prototype);
        obj.__wbg_ptr = ptr;
    ...
    free() {
        ...
        wasm.__wbg_tomldocument_free(ptr);
    }
    /**
    ...
    */
    constructor(toml) {
        try {
            ...
            wasm.tomldocument_new(retptr, ptr0, len0);
    ...
    */
    set(key, value) {
        try {
            ...
            const len0 = WASM_VECTOR_LEN;
            wasm.tomldocument_set(retptr, this.__wbg_ptr, ptr0, len0, addHeapObject(value));
            var r0 = getInt32Memory0()[retptr / 4 + 0];
            var r1 = getInt32Memory0()[retptr / 4 + 1];
            var r2 = getInt32Memory0()[retptr / 4 + 2];
            if (r2) {
    ...
    */
    get(key) {
        const ptr0 = passStringToWasm0(key, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.tomldocument_get(this.__wbg_ptr, ptr0, len0);
    ...
    */
    toString() {
        ...
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            wasm.tomldocument_toString(retptr, this.__wbg_ptr);
            var r0 = getInt32Memory0()[retptr / 4 + 0];
            var r1 = getInt32Memory0()[retptr / 4 + 1];
            deferred1_0 = r0;
            deferred1_1 = r1;
    ...
    */
    toObject() {
        const ret = wasm.tomldocument_toObject(this.__wbg_ptr);
        return takeObject(ret);
    }
}
module.exports.TomlDocument = TomlDocument;
...
module.exports.__wbg_new_d77fabdc03b9edd6 = function(arg0) {
    const ret = new Date(getObject(arg0));
    return addHeapObject(ret);
};

module.exports.__wbg_instanceof_Object_702c4990f4c3db8d = function(arg0) {
    let result;
    try {
...
const path = require('path').join(__dirname, 'covector_toml_bg.wasm');
